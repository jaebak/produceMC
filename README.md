...
# At CERN for rhel6
singularity shell -B /cvmfs -B /etc/grid-security -B /afs/cern.ch/work/j/$USER/analysis /cvmfs/singularity.opensciencegrid.org/cmssw/cms:rhel6-m20201113
# At CMSConnect
singularity shell -B /cvmfs -B /etc/grid-security -B /ospool/cms-user/$USER /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/cc7:x86_64
