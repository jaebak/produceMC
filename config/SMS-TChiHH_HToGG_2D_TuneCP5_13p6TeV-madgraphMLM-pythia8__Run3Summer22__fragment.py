# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_fragment/SUS-Run3Summer22GS-00026
...
def events(dm):
  if dm==150: return 53
  elif dm==200 or dm==250: return 95
  elif dm==300 or dm==350: return 53
  elif dm>=400: return 33

# -------------------------------
#    Constructing grid

xmin, xmax, xstep = 200, 700, 50
ymin, ymax, ystep = 0, 550, 50

mpoints = []
mpoints.append([150,0,events(150)])

for mx in range(xmin, xmax+1, xstep):
  for my in range(ymin, mx-150+1, ystep):
