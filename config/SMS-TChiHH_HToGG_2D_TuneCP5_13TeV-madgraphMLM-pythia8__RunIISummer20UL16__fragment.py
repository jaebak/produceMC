...
xmin, xmax, xstep = 200, 1000, 100
ymin, ymax, ystep = 0, 1000, 100

# -------------------------------
#    Constructing grid

mpoints = []
mpoints.append([150,0,nevt])
for mx in range(xmin, xmax+1, xstep):
  for my in range(ymin, mx-125+1, ystep):
    if mx-my>175 and (mx%50!=0 or my%50!=0): 
      continue
    mLSP = my
    if mx==125:
      mx = mx + 2
...
for point in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            #GridpackPath =  cms.string('/net/cms18/cms18r0/jbkim/produceMC/SMS-N2N3/v1/SMS-%s_mN-%i_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz' % (process,mchi)),
