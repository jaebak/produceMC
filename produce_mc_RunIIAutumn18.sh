...
cmsDriver.py  --python_filename MiniAODv3_"$TAG"_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:\$Output_filename --conditions 102X_upgrade2018_realistic_v15 --step PAT --geometry DB:Extended --filein file:\$Input_filename --era Run2_2018 --fast --runUnscheduled --no_exec --mc -n -1
...
echo "----NanoAODv7----"
# https://cms-pdmv.cern.ch/mcm/requests?prepid=SUS-RunIIAutumn18NanoAODv7-00304&page=0&shown=524415
echo "Setting up CMSSW"
export SCRAM_ARCH=slc6_amd64_gcc700
source /cvmfs/cms.cern.ch/cmsset_default.sh
...
cmsDriver.py --python_filename NanoAODv7_"$TAG"_cfg.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:\$Output_filename --conditions 102X_upgrade2018_realistic_v21 --step NANO --filein file:\$Input_filename --era Run2_2018,run2_nanoAOD_102Xv1 --fast --no_exec --mc -n -1
