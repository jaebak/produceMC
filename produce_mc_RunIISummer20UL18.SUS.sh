...
if [ ! -f "valid_premix_fragment_2018" ]; then
  echo 'valid_premix_fragment_2018 does not exist'
  exit
fi
...
echo "----GEN----"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_test/SUS-RunIISummer20UL18GEN-00108
...
cmsDriver.py Configuration/GenProduction/python/$Fragment_filename --era Run2_2018 --customise Configuration/DataProcessing/Utils.addMonitoring --beamspot Realistic25ns13TeVEarly2018Collision --step GEN --geometry DB:Extended --conditions 106X_upgrade2018_realistic_v4 --customise_commands process.source.numberEventsInLuminosityBlock="cms.untracked.uint32(200) \n  process.source.firstRun = cms.untracked.uint32(${JOBNUM})" --datatier GEN --eventcontent RAWSIM --python_filename "$TAG"__LHE__cfg.py --fileout file:\$Output_filename -n $NEVENTS --no_exec --mc

echo "Run cmssw with configuration file"
cmsRun "$TAG"__LHE__cfg.py

echo "----SIM----"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_test/SUS-RunIISummer20UL18SIM-01558
echo "Setting up CMSSW"
export SCRAM_ARCH=slc7_amd64_gcc700
source /cvmfs/cms.cern.ch/cmsset_default.sh
if [ -r CMSSW_10_6_47/src ] ; then
...
cmsDriver.py  --era Run2_2018 --customise Configuration/DataProcessing/Utils.addMonitoring --beamspot Realistic25ns13TeVEarly2018Collision --step SIM --geometry DB:Extended --conditions 106X_upgrade2018_realistic_v11_L1v1 --datatier GEN-SIM --eventcontent RAWSIM --python_filename "$TAG"__SIM__cfg.py --fileout file:\$Output_filename --filein file:\$Input_filename -n -1 --runUnscheduled --no_exec --mc

echo "Run cmssw with configuration file"
cmsRun "$TAG"__SIM__cfg.py

echo "----DIGIPREMIX----"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_test/SUS-RunIISummer20UL18DIGIPremix-01729
echo "Setting up CMSSW"
export SCRAM_ARCH=slc7_amd64_gcc700
source /cvmfs/cms.cern.ch/cmsset_default.sh
if [ -r CMSSW_10_6_47/src ] ; then
...
cmsDriver.py  --era Run2_2018 --customise Configuration/DataProcessing/Utils.addMonitoring --procModifiers premix_stage2 --datamix PreMix --step DIGI,DATAMIX,L1,DIGI2RAW --geometry DB:Extended --conditions 106X_upgrade2018_realistic_v11_L1v1 --datatier GEN-SIM-DIGI --eventcontent PREMIXRAW --python_filename "$TAG"__DIGIPREMIX__cfg.py --fileout file:\$Output_filename --filein file:\$Input_filename -n -1 --pileup_input "dbs:/Neutrino_E-10_gun/RunIISummer20ULPrePremix-UL18_106X_upgrade2018_realistic_v11_L1v1-v2/PREMIX" --runUnscheduled --no_exec --mc

echo "Make cmssw configuration file with valid premix files"
python replace_premix.py -i "$TAG"__DIGIPREMIX__cfg.py -v valid_premix_fragment_2018 -o "$TAG"__DIGIPREMIX__validPremix__cfg.py

echo "Run cmssw with configuration file"
cmsRun "$TAG"__DIGIPREMIX__validPremix__cfg.py

echo "----HLT----"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_test/SUS-RunIISummer20UL18HLT-01893
echo "Setting up CMSSW"
export SCRAM_ARCH=slc7_amd64_gcc700
source /cvmfs/cms.cern.ch/cmsset_default.sh
...
echo "----RECO----"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_test/SUS-RunIISummer20UL18RECO-01894
echo "Setting up CMSSW"
export SCRAM_ARCH=slc7_amd64_gcc700
source /cvmfs/cms.cern.ch/cmsset_default.sh
if [ -r CMSSW_10_6_47/src ] ; then
...
cmsDriver.py  --era Run2_2018 --customise Configuration/DataProcessing/Utils.addMonitoring --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --geometry DB:Extended --conditions 106X_upgrade2018_realistic_v11_L1v1 --datatier AODSIM --eventcontent AODSIM --python_filename "$TAG"__AOD__cfg.py --fileout file:\$Output_filename --filein file:\$Input_filename -n -1 --runUnscheduled --no_exec --mc

echo "Run cmssw with configuration file"
cmsRun "$TAG"__AOD__cfg.py

echo "----MiniAODv2----"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_test/SUS-RunIISummer20UL18MiniAODv2-01978
echo "Setting up CMSSW"
export SCRAM_ARCH=slc7_amd64_gcc700
source /cvmfs/cms.cern.ch/cmsset_default.sh
...
echo "----NanoAODv9----"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_test/SUS-RunIISummer20UL18NanoAODv9-01971
echo "Setting up CMSSW"
export SCRAM_ARCH=slc7_amd64_gcc700
source /cvmfs/cms.cern.ch/cmsset_default.sh
if [ -r CMSSW_10_6_47_patch1/src ] ; then
